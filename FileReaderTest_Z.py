...
#
#    dt = np.diff(myDat.time)
#    DTimeSplitter = 100
#    sepInd = np.where(dt>DTimeSplitter)[0]
#    
#    plt.figure()
#    oldInd = -1
#    for sep in sepInd:
#        ind = range(oldInd+1, sep)
#        time = myDat.freq[ind]
#        time = time - time[0]
#        plt.loglog(time, myDat.Z[ind])
#        oldInd = sep
#        print len(time)
#        
